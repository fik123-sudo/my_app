...
//the fllwing to code will conside to fllwing to next setion 
...
question.prototype
Quiz.prototype
//the fllwing  to change will commited to git 
function topup
...
function topof(){
    console.log("chage will be done")
}
